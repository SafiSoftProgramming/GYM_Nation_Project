...
--
-- Dumping data for table `members_at_the_gym`
--

INSERT INTO `members_at_the_gym` (`_id`, `member_name`, `member_photo`, `member_start_date`, `member_end_date`, `plane`, `workout_one_name`, `workout_two_name`, `enter_member_time_date`, `rfid`, `enter_member_date`) VALUES
(245, 'melegy', 'members_profile_imgs/Social_GymC03120A8.jpg', '2020-10-30', '2020-12-30', 'tow month', 'Leg', 'Crossfit', '07:45 PM', 'C0 31 20 A8', '05-November-2020'),
(246, 'xx', 'members_profile_imgs/Social_GymC03120A8.jpg', '2020-10-29', '2020-12-29', 'tow month', 'Cardio', '', '07:45 PM', 'C6 88 7C 89', '05-November-2020'),
(247, 'mahmoud el mlah abo', 'members_profile_imgs/Gymno.332DD97789.jpg', '2020-11-05', '2021-01-05', 'tow month', 'Back', 'Shoulders', '08:07 PM', '2D D9 77 89', '05-November-2020'),
(248, 'moomoi dfiousdh fpodjfiodsj ijhfisodhfsdihf udhfu kdfkdh uhds udhs', 'members_profile_imgs/defult_user_profile.png', '2020-10-29', '2020-12-29', 'tow month', 'Cardio', 'Crossfit', '08:16 PM', 'E6 F4 4B 79', '05-November-2020');
...
(58, 'mahmoud el mlah abo', '012557898887', '2020-01-01', '2020-11-05', '2021-01-05', 'tow month', 'female', '34', '342', '2020-01-29', 'dfdsf', 'dfsdfsd', '34', 'members_profile_imgs/Gymno.332DD97789.jpg', '2D D9 77 89'),
(61, 'Ahmed adel el mestkany', '011245874', '2020-01-01', '2020-10-30', '2020-12-30', 'tow month', 'male', '34', '34', '2008-08-14', 'dsfgdfg', 'dsfdsf', '34', 'members_profile_imgs/Gymno.3710426C89.jpg', '10 42 6C 89'),
...
(64, 'melegy', '23154654065046', '2020-01-08', '2020-10-30', '2020-12-30', 'tow month', 'female', '85', '85', '2020-01-09', 'yyyyy', 'yyyyy', '34', 'members_profile_imgs/Social_GymC03120A8.jpg', 'C0 31 20 A8');
...
--
ALTER TABLE `members_at_the_gym`
  MODIFY `_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=250;
...
--
ALTER TABLE `notification`
  MODIFY `_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=119;
